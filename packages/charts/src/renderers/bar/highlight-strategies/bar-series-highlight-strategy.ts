...
export class BarSeriesHighlightStrategy implements IHighlightStrategy<IRectangleAccessors, BarRenderer> {
    ...
    public findDataPointByValue(series: IDataSeries<IRectangleAccessors>, value: any, scaleKey: keyof IXYScales) {
