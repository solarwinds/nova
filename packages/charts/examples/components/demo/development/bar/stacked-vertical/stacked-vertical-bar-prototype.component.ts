...
@Component({
    ...
    templateUrl: "./stacked-vertical-bar-prototype.component.html",
})

export class StackedVerticalBarPrototypeComponent implements OnInit {
    public chartAssist: ChartAssist;

    ngOnInit() {
        const chart = new Chart(barGrid());
        const bottomAxis = (chart.getGrid().config() as XYGridConfig).axis.bottom;
        bottomAxis.tickLabel.overflowHandler = undefined;
        bottomAxis.fit = true;
    ...
    return [
        {
            ...
            "data": [
                ...
                {
                    "name": "Q3 2018 Q3 2018 Q3 2018 Q3 2018 Q3 2018 Q3 2018 Q3 2018",
                    "value": 141,
                },
                {
                    "name": "Q4 2018 Q4 2018 Q4 2018 Q4 2018",
                    "value": 66,
                },
            ],
        },
