...
export class RadialSeriesAtom extends SeriesAtom {
    ...
    private firstCurveMatcher = /M{1}-?\d*\.?\d+\w?-?\d*,{1}-?\d+\.?\d*A{1}\d+,{1}\d+,{1}\d{1},{1}\d{1},{1}\d{1},{1}-?\d*\.?\d*\w{1}?-?\d*,?-?\d*\.?\d*/g;
    private secondCurveMatcher = /L{1}-?\d*\.?\d+\w?-?\d*,{1}-?\d+\.?\d*A{1}\d+,{1}\d+,{1}\d{1},{1}\d{1},{1}\d{1},{1}-?\d*\.?\d*\w{1}?-?\d*,?-?\d*\.?\d*Z{1}$/g;
