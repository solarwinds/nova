...
@Component({
    template: `<div nuiResizeObserver (containerResize)="containerResizeHandler(entry)"></div>`,
})
        ...
        beforeEach(() => {
            TestBed
                .configureTestingModule({
                    declarations: [ResizeObserverTestingComponent, ResizeObserverDirective],
                    providers: [],
                });
            fixture = TestBed.createComponent(ResizeObserverTestingComponent);
            component = fixture.componentInstance;

            resizeObserverDebugElement = fixture.debugElement.query(By.directive(ResizeObserverDirective));
            subject = resizeObserverDebugElement.injector.get(ResizeObserverDirective) as ResizeObserverDirective;
        });
