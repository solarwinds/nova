...
@Component({
    template: `<div style="position: relative; height: 50px">
                    <div class="resize-gutter-element"
                        nuiResizer
...
describe("directives >", () => {
    describe("resizer", () => {
        ...
        beforeEach(() => {
            ...
            resizeSplitDebugElement = fixture.debugElement.query(By.directive(ResizerDirective));
            subject = resizeSplitDebugElement.injector.get(ResizerDirective) as ResizerDirective;
        });
        ...
        it("should have correct class have when nuiResizerDisabled input is set to true", () => {
            ...
            fixture.detectChanges();
            const resizeElement = resizeSplitDebugElement.nativeElement.firstChild;
            expect(resizeElement.classList).toContain("nui-resize-gutter-disabled");
        });
        it("should have correct class when direction is 'right'", () => {
            ...
            expect(resizeSplitElement.classList).toContain("nui-resize-gutter__split-horizontal");
        });
        ...
        it("should have correct class when direction is 'top'", () => {
            ...
            const resizeElement = resizeSplitDebugElement.nativeElement.firstChild;
            const resizeSplitElement = resizeElement.firstChild;
            expect(resizeSplitElement.classList).toContain("nui-resize-gutter__split-vertical");
        });
        ...
        it("should have correct classes while mouse events emitted", () => {
            ...
            expect(resizeElement.classList).toContain("nui-resize-gutter--active");

            document.dispatchEvent(new MouseEvent("mouseup"));
            expect(resizeElement.classList).not.toContain("nui-resize-gutter--active");
        });
    });
});
