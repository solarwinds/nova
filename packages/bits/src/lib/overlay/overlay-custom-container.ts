...
/** @dynamic */
@Injectable()
export class OverlayCustomContainer extends OverlayContainer implements OnDestroy {

    constructor(@Inject(DOCUMENT) document: Document, platform: Platform, private overlayService: OverlayContainerService) {
