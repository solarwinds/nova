    ...
    implements OnInit, OnChanges
{
    ...
    private getBorderWidths(element: HTMLTextAreaElement): ElementPadding {
        const getBorderWidth = (direction: string): number => this.getPixelPropertyValue(
                element,
    ...
    private getPaddings(element: HTMLTextAreaElement): ElementPadding {
        const getPaddingSize = (direction: string): number => this.getPixelPropertyValue(element, "padding-" + direction);
