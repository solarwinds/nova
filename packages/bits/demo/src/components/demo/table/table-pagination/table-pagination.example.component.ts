...
import { ClientSideDataSource, INovaFilteringOutputs, PaginatorComponent } from "@solarwinds/nova-bits";
...
export class TablePaginationExampleComponent implements AfterViewInit, OnDestroy {
