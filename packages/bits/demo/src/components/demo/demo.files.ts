...
export const DEMO_PATHS = [
    ...
    "color-picker/color-picker-basic/color-picker-basic.example.component.html",
    "color-picker/color-picker-basic/color-picker-basic.example.component.ts",
    "color-picker/color-picker-docs/color-picker-docs.example.component.html",
    "color-picker/color-picker-docs/color-picker-docs.example.component.ts",
    "color-picker/color-picker-palette/color-picker-palette.example.component.html",
    "color-picker/color-picker-palette/color-picker-palette.example.component.ts",
    "color-picker/color-picker-select/color-picker-select.example.component.html",
    "color-picker/color-picker-select/color-picker-select.example.component.ts",
    "color-picker/color-picker.module.ts",
