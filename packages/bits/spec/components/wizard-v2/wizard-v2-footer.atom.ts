...
export class WizardV2FooterAtom extends Atom {
    ...
    public get nextButton(): ButtonAtom {
        return new ButtonAtom(this.getElement().element(by.css("button[nuiwizardnext]")));
    }

    public get previousButton(): ButtonAtom {
        return new ButtonAtom(this.getElement().element(by.css("button[nuiwizardprevious]")));
    }
}
