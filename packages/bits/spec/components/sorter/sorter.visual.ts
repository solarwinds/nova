...
describe(`Visual tests: ${name}`, () => {
    ...
    it(`${name} visual test`, async () => {
        ...
        await camera.say.cheese("Legacy string input sorting direction changed");
        ...
        await camera.say.cheese("Legacy string input sorter: first item selected");
        ...
        await camera.say.cheese("Legacy string input sorter: last item selected");
