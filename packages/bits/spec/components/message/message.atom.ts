...
export class MessageAtom extends Atom {
    ...
    public getDismissButton = (): ElementFinder => this.root.element(by.className("nui-message-dismiss-button"));
    ...
    public dismissMessage = async (): Promise<void | null> => {
        ...
        await button.click();
        return browser.wait(ExpectedConditions.invisibilityOf(this.root), MessageAtom.animationDuration * 1.5);
    }
