    ...
    return [
        {
            ...
            data: [
                { x: moment(startOfToday).subtract(20, "day").toDate(), y: 30 },
        ...
        },
        {
            ...
            data: [
                { x: moment(startOfToday).subtract(20, "day").toDate(), y: 6000 },
                { x: moment(startOfToday).subtract(19, "day").toDate(), y: 6400 },
                { x: moment(startOfToday).subtract(18, "day").toDate(), y: 7000 },
                { x: moment(startOfToday).subtract(17, "day").toDate(), y: 5500 },
                { x: moment(startOfToday).subtract(16, "day").toDate(), y: 5500 },
                { x: moment(startOfToday).subtract(15, "day").toDate(), y: 4500 },
                { x: moment(startOfToday).subtract(14, "day").toDate(), y: 1000 },
                { x: moment(startOfToday).subtract(13, "day").toDate(), y: 6500 },
                { x: moment(startOfToday).subtract(12, "day").toDate(), y: 3500 },
                { x: moment(startOfToday).subtract(11, "day").toDate(), y: 6000 },
                { x: moment(startOfToday).subtract(10, "day").toDate(), y: 6100 },
                { x: moment(startOfToday).subtract(9, "day").toDate(), y: 6500 },
                { x: moment(startOfToday).subtract(8, "day").toDate(), y: 6300 },
                { x: moment(startOfToday).subtract(7, "day").toDate(), y: 5800 },
                { x: moment(startOfToday).subtract(6, "day").toDate(), y: 6400 },
                { x: moment(startOfToday).subtract(5, "day").toDate(), y: 6300 },
                { x: moment(startOfToday).subtract(4, "day").toDate(), y: 6000 },
                { x: moment(startOfToday).subtract(3, "day").toDate(), y: 6200 },
                { x: moment(startOfToday).subtract(2, "day").toDate(), y: 6100 },
                { x: moment(startOfToday).subtract(1, "day").toDate(), y: 6200 },
            ],
        },
        {
            id: "series-3",
            ...
            data: [
                { x: moment(startOfToday).subtract(20, "day").toDate(), y: 70 },
