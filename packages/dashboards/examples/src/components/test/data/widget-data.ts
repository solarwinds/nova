    ...
    const series: ITimeseriesWidgetData<any>[] = [
        {
            ...
            data: [
                {
                    x: frozenTime().subtract(30, "day").toDate(),
                    y: Status.Critical,
                },
                {
                    x: frozenTime().subtract(28, "day").toDate(),
                    y: Status.Warning,
                },
                {
                    x: frozenTime().subtract(27, "day").toDate(),
                    y: Status.Down,
                },
                {
                    x: frozenTime().subtract(26, "day").toDate(),
                    y: Status.Critical,
                },
                {
                    x: frozenTime().subtract(25, "day").toDate(),
                    y: Status.Down,
                },
                { x: frozenTime().subtract(24, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(23, "day").toDate(),
                    y: Status.Warning,
                },
                { x: frozenTime().subtract(19, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(17, "day").toDate(),
                    y: Status.Critical,
                },
                { x: frozenTime().subtract(16, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(14, "day").toDate(),
                    y: Status.Down,
                },
                { x: frozenTime().subtract(13, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(10, "day").toDate(),
                    y: Status.Warning,
                },
                { x: frozenTime().subtract(9, "day").toDate(), y: Status.Down },
                {
                    x: frozenTime().subtract(8, "day").toDate(),
                    y: Status.Critical,
                },
                { x: frozenTime().subtract(6, "day").toDate(), y: Status.Down },
                { x: frozenTime().subtract(5, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(4, "day").toDate(),
                    y: Status.Warning,
                },
        ...
        },
        {
            ...
            data: [
                ...
                {
                    x: frozenTime().subtract(24, "day").toDate(),
                    y: Status.Critical,
                },
                { x: frozenTime().subtract(23, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(19, "day").toDate(),
                    y: Status.Critical,
                },
                {
                    x: frozenTime().subtract(17, "day").toDate(),
    ...
    const series: ITimeseriesWidgetData<any>[] = [
        {
            ...
            data: [
                ...
                {
                    x: frozenTime().subtract(18, "day").toDate(),
                    y: Status.Warning,
                },
                {
                    x: frozenTime().subtract(17, "day").toDate(),
                ...
                {
                    x: frozenTime().subtract(16, "day").toDate(),
                    y: Status.Critical,
                },
                {
                    x: frozenTime().subtract(15, "day").toDate(),
                    y: Status.Down,
                },
                { x: frozenTime().subtract(14, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(13, "day").toDate(),
                    y: Status.Warning,
                },
                { x: frozenTime().subtract(12, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(11, "day").toDate(),
                    y: Status.Critical,
                },
                ...
                {
                    x: frozenTime().subtract(7, "day").toDate(),
                    y: Status.Warning,
                },
                { x: frozenTime().subtract(6, "day").toDate(), y: Status.Down },
                {
        ...
        },
        {
            ...
            data: [
                ...
                { x: frozenTime().subtract(13, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(12, "day").toDate(),
                    y: Status.Critical,
                },
                {
                    x: frozenTime().subtract(11, "day").toDate(),
                ...
                { x: frozenTime().subtract(7, "day").toDate(), y: Status.Down },
                {
                    x: frozenTime().subtract(6, "day").toDate(),
                    y: Status.Critical,
                },
                { x: frozenTime().subtract(5, "day").toDate(), y: Status.Down },
                { x: frozenTime().subtract(4, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(3, "day").toDate(),
                    y: Status.Critical,
                },
                { x: frozenTime().subtract(2, "day").toDate(), y: Status.Up },
                {
                    x: frozenTime().subtract(1, "day").toDate(),
                    y: Status.Warning,
                },
                { x: frozenTime().toDate(), y: Status.Warning },
            ],
