...
describe("TableFiltersConverterService >", () => {
    ...
    beforeEach(() => {
        ...
        service = new TableFiltersConverterService(eventBus, previewService, pizzagnaService);
    ...
    it("should properly pass data from preview to form pizzagna", () => {
        const columnsInFormPizzagna = pizzagnaService.pizzagna.data.filters.properties?.columns;
        ...
        const filtersInFormPizzagna = pizzagnaService.pizzagna.data.filters.properties?.sorterConfiguration;
        const filtersInPreviewPizzagna = TABLE_WIDGET_PREVIEW_PIZZAGNA.pizzagna.configuration.table.properties.configuration.sorterConfiguration;
    ...
    it("should properly update preview from form in editor", fakeAsync(() => {
        ...
        expectedPreviewPizzagna.table.properties.configuration.sorterConfiguration = mockedSortingState;
        component.form.get("sorterConfiguration")?.patchValue(mockedSortingState);
        tick(0);
