...
export class ConfiguratorHeadingComponent implements OnChanges {
    ...
    constructor(public el: ElementRef, private heading: ConfiguratorHeadingService) {}

    public ngOnChanges() {
        this.heading.height$.next(+getComputedStyle(this.el.nativeElement).height.slice(0, -2));
    }
}
